...
[:material-download: Descargar .pkt](../assets/files/lab-stp/lab-stp.pkt){ .md-button .md-button--primary download }
[:material-download: Descargar configs](../assets/files/lab-stp/configs.txt){ .md-button download }
